          ...
          <div className="flex flex-1 h-full min-h-0 w-full gap-3">
            ...
            <div className="flex-1 min-h-0 min-w-0 w-full">
              ...
              >
                    ...
                    <CardContent className="grid gap-3 p-4 pt-2 grid-cols-1">
                      ...
                      <div className="space-y-1.5">
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value={String(60 * 5 * 1000)}>
                              5 minutes
                            </SelectItem>
                            <SelectItem value={String(60 * 10 * 1000)}>
                              10 minutes
                            </SelectItem>
                            <SelectItem value={String(60 * 15 * 1000)}>
                              15 minutes
                            </SelectItem>
                            <SelectItem value={String(60 * 30 * 1000)}>
                              30 minutes
                            </SelectItem>
                          </SelectContent>
                        </Select>
                ...
                <ScrollMoreButton scrollElementRef={appearanceScrollRef} />
              </TabsContent>
              ...
              >
                ...
                <ScrollMoreButton scrollElementRef={accountScrollRef} />
              </TabsContent>
              ...
              >
                ...
                <ScrollMoreButton scrollElementRef={systemScrollRef} />
              </TabsContent>
            </div>
          </div>
        </Tabs>
