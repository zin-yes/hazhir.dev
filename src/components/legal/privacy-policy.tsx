export default function PrivacyPolicy() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16 text-gray-200">
      ...
      <p>
        Personal data is processed solely to provide the functionality of the
        web application, including authentication, file storage, and social
        features.
      </p>
      ...
      <p>
        ...
        service or until the user deletes their account.
      </p>
